...
Этот проект основан на [Element X iOS](https://github.com/element-hq/element-x-ios) с следующими модификациями:
...
### Лицензия:
- Исходный код: [AGPL-3.0](LICENSE)
- Производная работа: [AGPL-3.0](LICENSE)
- Коммерческая лицензия: [LICENSE-COMMERCIAL](LICENSE-COMMERCIAL)

### Соответствие AGPL-3.0:
1. Полный исходный код доступен в этом репозитории
2. Все модификации документированы в [MODIFICATIONS.md](MODIFICATIONS.md)
3. Сохранены оригинальные копирайты Element

### Для пользователей:
В соответствии с AGPL-3.0, вы имеете право на получение исходного кода этой модифицированной версии.
